"""hotspot — interaction-aware hot-spot prediction for protein-protein interfaces.
...
from hotspot.pipeline import analyze_complex  # noqa: E402  (public API convenience)
